...
<h3>After installing Xampp </h3>
        ...
        1. XAMPP Control Panel popup will appear
        2. Click on Explorer from XAMPP Control Panel
        3. Find php from that folder and open this and copy that Path (Example : C:\xampp\php )
