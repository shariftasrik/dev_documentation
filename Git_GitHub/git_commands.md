...
NOTE :  
** There will apear vim (a text editor), 
...
Git FORKING AND PULL REQUEST :
  1. Fork the repo in our GitHub
  2. Do you collaboration
  3. make commit with your changes to the 
     master branch of the main authors repo
  4. Click on the "New Pull Request" from your GitHub accounts repo
  5. Click on "Create Pull Request" with the appropiate message that what We've done
   
Then only the main author can merge the pull-request at his/her repo
